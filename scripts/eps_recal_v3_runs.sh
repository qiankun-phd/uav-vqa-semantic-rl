#!/usr/bin/env bash
# Task #28: epsilon recalibration iteration 3 -- attainability_v3 (structural
...
# utm_conflict + nominal).  All output under outputs/rl/eps_recal_v3.  Legacy /
...
TPE="${TPE:-20}"
SEEDS="${SEEDS:-0 1 2}"
OUT="${OUT:-outputs/rl/eps_recal_v3}"
CFG="configs/v1_9_bubbles.yaml"
CAL="attainability_v3"
...
echo "[recal] ==== epsilon recalibration v3 rerun start $(date) | cal=$CAL ccc=$CCC train_ep=$TRAIN_EP seeds=$SEEDS ===="
