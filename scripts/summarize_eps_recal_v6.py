#!/usr/bin/env python
"""Task #33/#34 v6: scale-consistency matrix summary + judgment.

Reads outputs/rl/eps_recal_v6 (comm-window deadlines, delta_esc peak 0.155 /
nominal 0.05 from outputs/rl/eps_v6_calib.json) and reports the v6 DOUBLE metric
...
ROOT = BASE / "eps_recal_v6"
CALIB = BASE / "eps_v6_calib.json"
LAMBDA_MAX = 20.0
...
print("=" * 140)
print("LAMBDA / ESCALATION TRAJECTORY (v6 peak training, terminal-window means)")
